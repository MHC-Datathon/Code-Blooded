          ...
          analysis && (
            <div className="absolute p-5 mt-2 h-7/8 top-16 right-4 text-lg w-110 overflow-auto bg-black text-white rounded-2xl custom-scroll">
              <span className={`${font1.className}`}>
                ...
                <br />
                <br />
                We highly recommend reading our paper for a more in depth analysis <a className="text-blue-400 underline" href="https://mhc-datathon.github.io/Code-Blooded/paper.pdf" target="_blank" rel="noopener noreferrer">Here</a>
              </span>
            </div>
          )
        }
